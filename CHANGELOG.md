...
- Updated dependencies [da5f58c]
  - @quincarter/document-viewer@0.1.3
...
- updated package to work with workers

### Patch Changes

- Updated dependencies
  - @quincarter/document-viewer@0.1.0
